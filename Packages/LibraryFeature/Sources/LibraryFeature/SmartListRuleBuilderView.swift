...
//
  ...
  public struct SmartListRuleBuilderView: View {
    public init(
      rule: Binding<SmartListRule>, onSave: @escaping (SmartListRule) -> Void,
  ...
  public struct SmartListCriteriaSelector: View {
    public init(
      criteria: Binding<EpisodeSelectionCriteria>,
      onApply: @escaping (EpisodeSelectionCriteria) -> Void, onCancel: @escaping () -> Void
    ) {}
  ...
  public struct SmartListRuleBuilderView: View {
    ...
    private var dateValueInput: some View {
      Group {
        ...
        case .between:
          DatePicker(
            "Start Date", selection: $ruleBuilder.startDateValue, displayedComponents: .date
          )
        ...
        VStack(alignment: .leading, spacing: 12) {
          DurationSlider(
            ...
            value: Binding(
              ...
              set: { newValue in
                let minutes =
                  (ruleBuilder.timeIntervalValue.truncatingRemainder(dividingBy: 3600)) / 60
