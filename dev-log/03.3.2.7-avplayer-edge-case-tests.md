...
| --- | --- | --- | --- |
| Missing Audio URL | UI | Blocked | Depends on 03.3.4 error UI/messages |
| Network Error + Retry | UI | Blocked | Depends on 03.3.4 error UI/messages |
| Audio Interruption | UI | Planned | Requires debug trigger in app |
| Playback Speed Affects Rate | UI | Planned | Uses AVPlayer + slider delta |
| Headphone Disconnect | Manual | Planned | Add checklist if route-change sim not feasible |
