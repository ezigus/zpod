...
- The tests still confirm the retry button’s presence/absence so recoverable paths remain asserted even though we avoid interrogating `ExpandedPlayer.ErrorView.label`.
