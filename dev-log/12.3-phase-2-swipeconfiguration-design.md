...
1. `SwipeConfigurationTestCase` now inherits `IsolatedUITestCase`, overrides `userDefaultsSuite`, and relies on the shared cleanup helpers instead of custom CI-only termination logic.
