...
- Re-enable `OfflinePlaybackUITests.testNonDownloadedEpisodeFailsOffline` by asserting the `PlaybackError.networkUnavailable` surface appears when launching in offline mode with no downloads.
