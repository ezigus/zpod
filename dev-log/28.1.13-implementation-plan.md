...
- [x] Task 1: Fix StreamingErrorHandler doc comment
- [x] Task 2: Add `.cancelDownload` to `SwipeActionType` enum
- [x] Task 3: Wire `.cancelDownload` visibility and action handler
- [x] Task 4: Add `cancelDownloadFocused` swipe preset to test support
- [x] Task 5: Add `testCancelDownloadResetsState()` UI test
- [x] Task 6: Add fallback-to-streaming integration tests
- [x] Task 7: Create `StreamingEdgeCaseIntegrationTests.swift`
- [x] Task 8: Run targeted test suites
- [x] Task 9: Run full regression
- [x] Task 10: Update issue file and dev-log
- [x] Task 11: Commit, push, update PR #403
...
- [x] All 12 offline playback spec scenarios have corresponding tests
- [x] All 7 streaming playback error/edge-case spec scenarios have corresponding tests
- [x] Download cancellation exposed via swipe action and tested
- [x] Fallback-to-streaming behavior tested at integration level
- [x] Retry backoff contract verified at integration level
- [x] StreamingErrorHandler doc comment matches actual delays
- [x] Zero `XCTSkip` in download or offline playback test files
- [x] Full regression passes (Syntax, AppSmoke 59/59, Integration 87/87, PlaybackEngine 49/49)
- [x] Issue file updated with 100% completion status
- [x] PR pushed and ready for review
