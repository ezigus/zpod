...
## Status: Complete
**Branch**: `feature/27.1.3-closeout`
**Created**: 2026-01-17
...
- Episode metadata is not persisted yet, so Siri snapshots can be sparse after app restart until feeds refresh.
- Follow-up dependency: Issue 28.1.8 (episode metadata persistence for Siri).
