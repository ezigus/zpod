...
- Mini player does not overlap with tab bar buttons
- All tab navigation buttons remain fully tappable when mini player is active
- Content scrolls properly and doesn't get hidden behind mini player
- Bottom safe area is properly respected on devices with notches/Dynamic Island
