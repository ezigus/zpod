...
**Status**: 🚧 In Progress (Decomposed into Sub-Issues)
...
**⚠️ IMPORTANT**: This issue blocks Issue 03.3.2.7 (AVPlayer Edge-Case Tests) from reaching 100% completion. Once 03.3.4 is complete, return to 03.3.2.7 to un-skip error tests.
...
- Invalid URL → appropriate error
- Server down → server error message
