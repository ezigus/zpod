...
**Scope Update (2026-01)**: Playback state remains the shared source of truth, but mini-player visibility is moving to a separate presentation state (pill vs expanded). Ensure synchronization remains correct while presentation is decoupled (see `03.1.1.6-mini-player-pill-reveal`).
