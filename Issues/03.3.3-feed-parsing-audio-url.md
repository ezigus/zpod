...
- [ ] `<enclosure url>` extracted and assigned to `Episode.audioURL`
- [ ] URL validated as parseable (not just any string)
- [ ] `<itunes:duration>` parsed (handles both seconds and HH:MM:SS format)
- [ ] Duration assigned to `Episode.duration`
- [ ] Missing enclosure logged but doesn't crash
- [ ] Invalid URL format logged but doesn't crash
- [ ] Unit tests with real RSS feed samples
- [ ] Sample feeds from popular podcasts verified working
