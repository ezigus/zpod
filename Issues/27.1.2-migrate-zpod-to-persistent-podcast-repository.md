...
2. **Spec alignment**: persistence-after-restart scenarios mapped to tests in `IntegrationTests/TestSummary.md`. ✅
...
- [x] Verify Siri snapshots still work with persistent repository ✅
  - Coverage: `IntegrationTests/PodcastPersistenceIntegrationTests.testSiriSnapshotReflectsPersistentData`
