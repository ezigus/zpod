...
- **28.1.1** - Download Manager Implementation ✅ Complete
- **28.1.2** - Local Storage and File Management ✅ Complete
- **28.1.3** - Streaming Engine with Buffering
- **28.1.4** - Network Monitoring and Adaptation
- **28.1.5** - Unified Playback Coordinator ✅ Complete ([#341](https://github.com/ezigus/zpod/issues/341))
- **28.1.6** - UI Integration (Download/Streaming Indicators) ✅ Complete ([#342](https://github.com/ezigus/zpod/issues/342))
- **28.1.7** - Test Infrastructure for Both Modes ([#343](https://github.com/ezigus/zpod/issues/343))
- **28.1.8** - Episode Metadata Persistence for Siri Snapshots
- **28.1.9** - UI Test Hardening
- **28.1.10** - Swipe Delete Download ✅ Complete ([#395](https://github.com/ezigus/zpod/issues/395))
- **28.1.11** - Network Simulation Test Hooks ✅ Complete ([#396](https://github.com/ezigus/zpod/issues/396))
- **28.1.12** - Network Error Display Tests ✅ Complete ([#401](https://github.com/ezigus/zpod/issues/401))
- **28.1.13** - Final Acceptance Criteria Completion (NEW - consolidates remaining work)
