...
5. **Testing Infrastructure** - Comprehensive test coverage for both modes
...
- **28.1.5** - Unified Playback Coordinator
- **28.1.6** - UI Integration (Download/Streaming Indicators)
- **28.1.7** - Test Infrastructure for Both Modes
