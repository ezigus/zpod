...
**Scope Update (2026-01):** The player UX is evolving to use a collapsed pill handle by default and to show the full player directly in the Player tab. Track the updated behavior in `03.1.1.6-mini-player-pill-reveal` and `03.1.1.7-player-tab-full-player`.
