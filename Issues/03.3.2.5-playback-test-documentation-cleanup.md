...
**GitHub Issue**: [#296](https://github.com/ezigus/zpod/issues/296)

**PR**: [#316](https://github.com/ezigus/zpod/pull/316)
...
//
// ⚠️ DEPRECATED: This file is replaced by:
...
```markdown
## 2026-01-04 — Test Restructuring Complete
...
**Validation**:
- ✅ Ticker tests pass locally
- ✅ AVPlayer tests pass locally
- ✅ CI pipeline validates both suites
...
|-----------|--------------|--------|
| Strategy doc complete | PLAYBACK_TESTS.md exists | ⏳ |
| TestSummary updated | Dual-mode section present | ⏳ |
| Original file deprecated | Warning visible | ⏳ |
| Dev-log updated | Completion entry added | ⏳ |
| All links valid | Click-through check | ⏳ |
| Instructions work | Follow locally | ⏳ |
