...
- Merged to main branch 2025-12-23 (full regression passed locally and in CI)

**Follow-up**: Issue 03.1.1.1.1 created for optional testing enhancements

**Scope Update (2026-01)**: The mini-player presentation is shifting to a hidden-by-default pill with swipe-up reveal and explicit hide. See `03.1.1.6-mini-player-pill-reveal` for the new UX requirements; the foundation work here remains valid for playback binding and controls.
