...
- ✅ 02.1.8.1 - CarPlay Siri Data Wiring (PR #122, merged)
- ✅ 02.1.8.2 - CarPlay HIG & Voice Validation (PR #123, merged)

### Implementation Summary

**All acceptance criteria met:**

- ✅ CarPlay scene configuration complete
- ✅ Simplified episode list UI with large touch targets
- ✅ Voice control integration (Siri + VoiceOver)
- ✅ Playback controls (play, queue management)
- ✅ Safety compliance (HIG validated)

### Implementation Progress (as of 2025-11-02 19:15 ET)
...
- CI preflight hardened with dynamic simulator destination selection to support older runner runtimes
- CI workflow now resolves shared Xcode schemes automatically to avoid build-for-testing failures
- **CarPlay scene manifest in Info.plist** (CPTemplateApplicationSceneSessionRoleApplication)
- **CarPlay audio entitlement** (com.apple.developer.carplay-audio)
- **Shared PodcastManager pattern** across iPhone UI, CarPlay, and Siri
- **NSUserActivity handler** for Siri playback requests (`us.zig.zpod.playEpisode`)

**⏳ Remaining (Sub-Issues):**

- **02.1.8.1**: Wire actual episode data to Siri resolver (connect PodcastManaging to search)
- **02.1.8.2**: CarPlay HIG compliance validation (touch targets, motion restrictions)
...
### Remaining Work for Full Siri Integration
