...
- [ ] **Voice Control** – CarPlay voice template is implemented; Siri intent plumbing still pending for broader voice command coverage.
- [ ] **Safety & HIG Compliance** – Continue auditing touch targets, motion restrictions, and highlight states against the HIG.
