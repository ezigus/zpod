...
- **Then** A minimal mini-player pill should appear above the tab bar
- **And** The pill should not block tab bar taps or primary content
- **When** I swipe up or tap the pill
...
- **And** I can collapse the mini-player back to the pill without stopping playback
...
1. **Mini-Player Component**
   - Create a persistent mini-player pill handle with expand/collapse presentation state
   - Ensure the pill does not obstruct the tab bar and respects safe-area insets
