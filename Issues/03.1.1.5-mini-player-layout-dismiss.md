...
## Status
🟦 Superseded (2026-01) — see `03.1.1.6-mini-player-pill-reveal`

**Closure Note**: Closed in favor of the pill-based presentation and full-player tab consolidation in `03.1.1.6-mini-player-pill-reveal` and `03.1.1.7-player-tab-full-player`.

## Description
This proposal has been superseded by the pill-based presentation and hidden-by-default mini-player flow. The updated UX requirements live in `03.1.1.6-mini-player-pill-reveal`, which replaces the original overlay/dismiss approach with a collapsed handle that expands and collapses on swipe.
