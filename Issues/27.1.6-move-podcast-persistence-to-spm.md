...
Closed as already complete. A codebase scan confirmed that `SwiftDataPodcastRepository.swift` already resides in `Packages/Persistence/Sources/Persistence/` — the migration to the SPM package was carried out as part of the persistence wiring work in Issue 27.1.2. All acceptance criteria were met; the issue was never formally closed. GitHub issue #352 closed with a matching comment.
