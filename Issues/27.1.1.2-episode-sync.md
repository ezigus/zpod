...
### Manual Verification
- [x] Refresh feed → new episodes added
- [x] Refresh feed → existing episode metadata updated
- [x] Refresh feed → playback position preserved on existing episodes
- [x] Episode removed from feed but has playback position → still present
- [x] Episode removed from feed with no user state → deleted
  - Completed manually on 2026-02-01.

### Full Regression
```bash
./scripts/run-xcode-tests.sh
```
Status: Completed (per 2026-02-01 run)
