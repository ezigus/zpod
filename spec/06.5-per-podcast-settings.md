...
|----------|-----------|-------|
| 1 (Access) | PodcastCustomSettingsUITests | long-press, detail nav, title display |
| 2 (Auto-Download) | PodcastCustomSettingsViewModelTests | override, restore global |
| 3 (Retention) | EpisodeRetentionTests | all policy options, restore global |
| 4 (Playback) | PodcastCustomSettingsViewModelTests | speed, skip intervals, restore global |
| 5 (Episode Sort) | EpisodeFilterRepositoryTests, PodcastCustomSettingsViewModelTests | override storage, global default removal |
| 6 (Priority) | PodcastPriorityTests | storage, default value, UI persistence |
| 7 (Notifications) | PodcastCustomSettingsViewModelTests | override, suppress, restore global |
| 8 (Override Indicator) | PodcastCustomSettingsUITests | badge display, tap navigation, zero = hidden |
| 9 (Reset) | PodcastCustomSettingsUITests, PodcastCustomSettingsViewModelTests | full reset, confirmation, partial reset guard |
